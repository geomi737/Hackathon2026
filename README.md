...
2.  В боковой панели загрузите **ZIP-архив** со спутниковыми данными.
3.  **Требования к архиву**:
    Архив должен содержать файлы каналов (форматы TIF, JP2 или PNG), соответствующие:
...
---
Разработано в рамках хакатона **Technostart 2026**.
